...
var config = {
    ...
    popup_redirect_uri: window.location.origin + "/" + clientPath + "/popup.html",
    ...
    scope: "openid email profile role customAPI.write",
    ...
    silent_redirect_uri: window.location.origin + "/" + clientPath + "/silent.html",
